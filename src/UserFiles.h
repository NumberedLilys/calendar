class UserFiles {
    ...
    public:
        UserFiles(const std::string& filename) : userFile(filename) {}
        void getLoginDetails(std::istream& in,
                     std::ostream& out,
                     std::string& username,
                     std::string& password){
        ...
        void getSignupDetails(std::istream& in,
                      std::ostream& out,
                      std::string& email,
                      std::string& username,
                      std::string& password) {
        ...
        std::string createUser(std::istream& in, std::ostream& out) {
            ...
            while (confirm_password != password) {  // Password confirmation loop
                out << "Passwords do not match. Please try again." << std::endl;
                out << "Please confirm your password: ";
                std::getline(in, confirm_password);
            }
